...
<body>
    ...
    <section>
        ...
        <!-- Forms -->
        <form class="form" action="/ProjectTechMovee_war_exploded/Telefone" method="get">
            <%
                if (request.getAttribute("erro") != null){
            %>
        ...
        <!-- Opções para o CRUD -->
        <div class="botoes">
            <a href="/ProjectTechMovee_war_exploded/Telefone"><button>Mostrar todos Telefones</button></a>
            <%
                if (request.getAttribute("erro") == null){
            %>
