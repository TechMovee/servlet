...
<body>
    ...
    <section class="conteudo">
        ...
        <!-- Opções para o CRUD -->
        <div class="botoes">
            <a href="/ProjectTechMovee_war_exploded/Escola"><button>Mostras todos Admins</button></a>
            <%
                if (request.getAttribute("erro") == null){
            %>
                <a href="areaRestritaEscolaId.jsp"><button>Buscar</button></a>
                <a href="areaRestritaEscolaInserir.jsp"><button>Inserir</button></a>
            ...
            %>
                ...
                <a href="AreaRestrita/Escola/areaRestritaEscolaInserir.jsp"><button>Inserir</button></a>
