...
<body>
    ...
    <section>
        ...
        <!-- Forms -->
        <form class="form" action="/ProjectTechMovee_war_exploded/Admin" method="post">
            <%
                if (request.getAttribute("erro") != null){
            %>
        ...
        <!-- Opções para o CRUD -->
        <div class="botoes">
            <a href="/ProjectTechMovee_war_exploded/Admin"><button>Mostras todos Admins</button></a>
            <%
                if (request.getAttribute("erro") == null){
            %>
                <a href="areaRestritaAdminId.jsp"><button>Buscar</button></a>
                <a href="areaRestritaAdminInserir.jsp"><button>Inserir</button></a>
                <a href="areaRestritaAdminAtualizar.jsp"><button>Atualizar</button></a>
            <%
            }else{
            %>
                <a href="AreaRestrita/Administrador/areaRestritaAdminId.jsp"><button>Buscar</button></a>
                <a href="AreaRestrita/Administrador/areaRestritaAdminInserir.jsp"><button>Inserir</button></a>
